...
⚡𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑 **[ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍⃟⃟⃟⃟⃟𝐕(زيزو](https://t.me/{OWNER_NAME}) **
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"https://t.me/SouorseZeZoMUSIC"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟(زيزو", url="https://t.me/SouorseZeZoMUSIC"
                    )
                ],
            ]
        ),
...
async def cbguides(_, query: CallbackQuery):
 ...
 ⚡ 🌀قناة سورس زيزو @SouorseZeZoMUSIC
__""",
        reply_markup=InlineKeyboardMarkup(
