    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("ᯓ𝐕𝘼𝙈𝘽𝙄𝙍زيزو", url=f"t.me/ZeZoMUSIC"),
              InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"t.me/SouorseZeZoMUSIC"),
                ],
              [InlineKeyboardButton("🎧اضافه البوت اللي مجموعتك🎧", url=f"http://t.me/M_U_S_I_C_900_bot?startgroup=new"),              
            ]
        ]
    )
    if m.sender_chat:
                    ...
                    if veez == 0:
                        ...
                        if chat_id in QUEUE:
                            ...
                            try:
                                ...
                                await suhu.delete()
                                await m.reply_text(f"خطاء قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر لكي اعمل @J_o_k_e_r_80 : `{ep}`")
                ...
                if amort == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        try:
                            ...
                            await suhu.delete()
                            await m.reply_text(f"خطاء قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه لكي اعمل @J_o_k_e_r_80 : `{ep}`")
