    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟زيزو", url=f"t.me/ZeZoMUSIC"),
                ...
                if veez == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        try:
                            ...
                            await loser.delete()
                            await m.reply_text(f"🚫 خطاء قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه @J_o_k_e_r_80 : `{ep}`")
